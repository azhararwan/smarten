		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<ul class="breadcrumb">
					...
					<li class="active">KPSP 3 Bulan</li>
				</ul>
				...
				<center><h4><i class="icon-edit icon-large"></i> KPSP 3 Bulan </h4>
				<hr>
					...
					<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
                        ...
                        <tbody>
                            <?php			
                                include('../connect.php');
                                $result = $db->prepare("SELECT * FROM kpsp WHERE id_kategori='k3' ORDER BY id ASC ");
                                $result->execute();
