		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<ul class="breadcrumb">
					...
					<li class="active">KPSP 36 Bulan</li>
				</ul>
				...
				<center><h4><i class="icon-edit icon-large"></i> KPSP 36 Bulan </h4>
				<hr>
                    ...
                    <form method="post" action="jawabankpsp.php">
						...
						<input type="hidden" style="width:200px; height:30px;" name="id_kategori" value="k36"/>
                        <span>Nama Anak :</span> &nbsp;
					...
					<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
                        ...
                        <tbody>
                            <?php			
                                include('../connect.php');
                                $result = $db->prepare("SELECT * FROM kpsp WHERE id_kategori='k36' ORDER BY id ASC ");
                                $result->execute();
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['pertanyaan']; 
										  if($row['gambar'] != null ){
										  	echo '<center> <img height=200px; src="data:image/png;base64,'.base64_encode( $row['gambar'] ).'"/> </center>'; 
										  }
									?>
								</td>
                                <td><?php echo $row['aspek']; ?></td>
                                <td><font><input type="radio" name="p[<?php echo $i ?>]" value="Ya" r
								equired> Ya </input> </font> &nbsp; &nbsp;
