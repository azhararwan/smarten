		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<ul class="breadcrumb">
					...
					<li class="active">KPSP 48 Bulan</li>
				</ul>
				...
				<center><h4><i class="icon-edit icon-large"></i> KPSP 48 Bulan </h4>
				<hr>
                    ...
                    <form method="post" action="jawabankpsp.php">
						...
						<input type="hidden" style="width:200px; height:30px;" name="id_kategori" value="k48"/>
                        <span>Nama Anak :</span> &nbsp;
					...
					<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
                        ...
                        <tbody>
                            <?php			
                                include('../connect.php');
                                $result = $db->prepare("SELECT * FROM kpsp WHERE id_kategori='k48' ORDER BY id ASC ");
                                $result->execute();
