    ...
    <div class="container-fluid">
		...
		<div id="login">
			...
			<form action="login.php" method="post">
				<font style=" font:bold 44px 'Aleo'; color:#fff;"><center>SMARTEN</center></font>
				<br>
				...
				<div class="qwe">
				<button class="btn btn-large btn-primary btn-block pull-right" href="dashboard.html" type="submit"><i class="icon-signin icon-large"></i> Masuk</button>
				</div>
